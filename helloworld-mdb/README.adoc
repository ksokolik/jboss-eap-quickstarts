...
//*************************************************
// Remote ActiveMQ Artemis integration
//*************************************************

== Remote ActiveMQ Artemis integration

For testing a remote ActiveMQ Artemis integration run ActiveMQ Artemis locally with user/pass admin/admin and add
following to the standalone-full.xml JBoss EAP 7.2 configuration:
...
Add:
        ...
        <pooled-connection-factory name="remote-artemis" entries="java:/jms/RemoteArtemisCF" connectors="remote-artemis" user="admin" password="admin"/>
...
Deploy application, open servlet:
http://localhost:8080/helloworld-mdb/HelloWorldMDBServletClientRemote